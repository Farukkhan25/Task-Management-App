...
const Header = () => {
  ...
  const menuItems = (
    <>
      {user?.email ? (
        <>
          <button
            className="font-semibold list-none mr-4 my-2 px-2 py-2 lg:my-0 lg:px-4  rounded-lg  bg-blue-600 hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-300  dark:bg-blue-900 dark:hover:bg-blue-700 dark:focus:ring-blue-700"
        ...
        <>
          <li className="font-semibold list-none">
            ...
            <Link
              to="/register"
              className="font-bold list-none ml-1  px-2 py-2 lg:my-0 lg:px-4  rounded-lg  hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-300  dark:hover:bg-blue-700 dark:hover:text-white dark:focus:ring-blue-700"
            >
              Register
            </Link>
          </li>
  ...
  return (
    ...
    >
      <div className="container lg:px-12 flex justify-between lg:py-1 mx-auto">
        <div className="flex">
          <Link
        ...
        <div className="items-center  hidden lg:flex">{menuItems}</div>
              ...
              <div className="p-8 bg-white dark:bg-violet-400 dark:text-gray-900 border rounded shadow-sm">
                ...
                <nav className="flex justify-center">
                  <ul className="text-center space-y-4 px-8 py-4 bg-purple-200 w-72">
                    ...
                    <li className="text-sky-600 inline-block">{menuItems}</li>
                  </ul>
                </nav>
              </div>
            </div>
